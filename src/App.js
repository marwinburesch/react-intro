...
const beers = {
  name: "beers",
  items: ["Punk IPA", "Hoevels", "Chainbreaker", "Elvis Juice"],
};
const animals = {
  name: "animals",
  items: ["Sloth", "Ant", "Elephant", "Elvis"],
};
